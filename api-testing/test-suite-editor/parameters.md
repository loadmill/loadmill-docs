...
You may embed parameters with the `${}` syntax in the request URL as well as the request body, request headers, [extractions](parameters.md#parameter-extraction), [assertions](https://docs.loadmill.com/api-testing/test-suite-editor/parameters/assertions) and more.
