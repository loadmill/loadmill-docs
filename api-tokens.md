...
In order to use the [Loadmill](https://www.loadmill.com) [REST API]() and or the Loadmill [node module and CLI](https://www.npmjs.com/package/loadmill), you will need to generate an **API Token**.
