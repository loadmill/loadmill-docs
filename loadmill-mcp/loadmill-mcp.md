...
![Run tests and see failures](<../.gitbook/assets/mcp-run-tests-fail (1).png>)
...
![Analyze failures and fix code](<../.gitbook/assets/mcp-run-tests-fix (1).png>)
...
![All tests pass](<../.gitbook/assets/mcp-run-tests-pass (1).png>)
...
![Generating a test from free text](<../.gitbook/assets/mcp-test-generation (1).png>)
