...
| Run with overrides (![](<../../.gitbook/assets/image (147).png>))                                         | Run the edited flow as usual, but [override some parameters](flow-execution.md#running-with-overrides).                                                                    |
...
Easily convert an API flow to Load test by clicking on the Flow options and select "Convert to Load Test". Once you've selected ![](<../../.gitbook/assets/image (142).png>), a new Load test will open containing all the requests and properties taken from the original API test.
