...
You can also apply specific filters if you want to register requests relevant to your test case flow. As well as adding domains in case you want to register our-of-domain APIs such as third-party APIs that is necessary for completing your flow. See the [**Test Composer Setup**](../loadmill-test-composer/quickstart.md) for more info on the composer features.
