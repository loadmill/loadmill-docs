...
* `--no-api` - can be supplied in order to run [Load tests](../../load-testing/getting-started-1.md) only, [API tests](../../quick-guide/quick-start-guide.md) will run on Loadmill servers.
