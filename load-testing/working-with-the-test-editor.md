...
| 4. Advanced Settings | Configure Iterations, E-mail notifications, enable Cookies, [Import CSV](creating-a-parameterized-load-test.md) and more.                    |
| 5. Replace Parameter | Easily replace the parameter you wish so all of the flow's requests will be affected.                                                                                                          |
|    Extract Parameter | [Extract a value to a parameter](../test-editor/flows/flow-controls.md#extract-parameter) from all across the test requests.                               |
