...
In this step, we will test the Algorithm component.
...
![Share in chat box](../assets/upload-har-via-chat.png)
...
![Download page placeholder](../assets/download-da-page.png)
